...
- [Blue crosshair canvas artifact](canvas-blue-crosshair.md) — intermittent full-viewport blue line = degenerate gradient axis spike; if it recurs, bisect by unmounting KnowledgeGraph.
