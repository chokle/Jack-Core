...
const OFFICE_FILLER_PATTERNS = [
  /\s*if you need to dive deeper into specific aspects(?:,\s*(?:let me know|feel free to ask|i can (?:help|clarify)))?[.!?]*\s*$/i,
  /^(?:sure|certainly|absolutely|of course)[,.:!?]?\s*/i,
  /\b(?:please\s+)?let me know(?:\s+(?:what you need|how i can help|if you need anything|if that helps|when you(?:'re| are) ready))?[.!?]*\s*$/gi,
  ...
  /\b(?:i can|i['’]m here to|i am here to)\s+(?:help|assist)(?:\s+you)?\s+with\s+that[.!?]*/gi,
