...
- When asked what a Jack app surface does, use the server-owned system map to distinguish its product goal from current capabilities. Do not infer plausible site features from the surface name or describe planned features as live.
