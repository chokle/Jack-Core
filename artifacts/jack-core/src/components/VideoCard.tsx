    ...
    >
      ...
      <div className="p-4 flex flex-col flex-1">
        <div className="flex justify-between items-start mb-2 gap-2">
          <Badge
            variant="outline"
            className="font-mono uppercase text-[10px] bg-sidebar border-sidebar-border text-sidebar-foreground"
          >
            {video.trade || "Uncategorized"}
          </Badge>
          <Badge
            variant="outline"
            className={`font-mono text-[10px] border ${getStatusColor(video.status)}`}
          >
