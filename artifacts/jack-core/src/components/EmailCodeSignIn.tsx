  ...
  return (
    <div className="w-full max-w-md overflow-hidden rounded-2xl border border-border bg-card shadow-2xl">
      <div className="space-y-6 p-7 sm:p-9">
        <div className="text-center">
          ...
          <h1 className="text-xl font-semibold text-foreground">
            Pilot participant access
          </h1>
          <p className="mt-1 text-sm text-muted-foreground">
            Sign in with the account assigned to you for the controlled field
            pilot.
          </p>
        </div>
      ...
      <div className="border-t border-border bg-muted/20 px-6 py-4 text-center text-sm text-muted-foreground">
        Need a pilot account? Contact your Torch pilot lead for an assigned
        access link.
      </div>
    </div>
  );
