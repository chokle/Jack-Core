  ...
  return (
    ...
    >
      ...
      >
        <AlertDialogHeader>
          <AlertDialogTitle>
            Required telemetry to join this pilot
          </AlertDialogTitle>
          <AlertDialogDescription asChild>
            <div className="space-y-3 text-left text-sm">
              <p>
                Jack cannot create or resume a pilot test session until you
                grant minimized core telemetry for this pilot. This is required
                for Pilot 001 participation and is separate from recording
                permissions.
              </p>
              <p>
              ...
              <p>
                ...
                reports show recording status, not the media.
              </p>
              <p>
              ...
              <label className="flex gap-3 rounded-lg border border-border p-3">
                ...
                <span>
                  ...
                  <span className="block text-muted-foreground">
                    Required to create and run any pilot test session for this
                    account.
                  </span>
                </span>
              </label>
