...
export const askJackBodyAuthorityContextPermitApplicationDateRegExp =
  new RegExp("^\\d{4}-\\d{2}-\\d{2}$");

export const AskJackBody = zod.object({
  message: zod.string().min(1),
  authorityContext: zod
    .object({
      province: zod.string().optional(),
      municipality: zod.string().optional(),
      permitApplicationDate: zod
        .string()
        .regex(askJackBodyAuthorityContextPermitApplicationDateRegExp)
        .optional()
        .describe(
      ...
      mineRelated: zod.boolean().optional(),
...
export const AskJackResponse = zod.object({
  ...
  citations: zod.array(
    zod.object({
      ...
      thumbnailUrl: zod.string().nullish(),
      sourceType: zod
        .enum(["video", "knowledge", "authority"])
        .optional()
        .describe(
      ...
      sourceStatus: zod
        .enum(["current", "superseded", "requires_review"])
        .optional(),
      officialSourceUrl: zod.string().url().optional(),
      amendmentIndicator: zod
        .enum(["bc_amendment", "vancouver_specific", "none"])
        .optional(),
      contentAvailability: zod
        .enum(["metadata_only", "licensed_section"])
        .optional(),
    }),
  ),
